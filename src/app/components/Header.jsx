...
export default function Header() {
    ...
    return (
        <header className="bg-white border-b-2 border-gray-200 px-6 ">
            <div className=" mx-auto px-4 sm:px-6 lg:px-4 py-2">
                <div className="flex items-center justify-between">
                    ...
                    {/* side menu */}
                    <div className={`fixed top-0 flex p-2 flex-col backdrop-blur-xl z-50 gap-y-2 min-h-screen bg-gray-200/80 right-0 w-1/2 h-full shadow-lg transition-all duration-300 ${isMenuOpen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 pointer-events-none'}`}>
                        <button
                            onClick={() => toggleMenu()}
